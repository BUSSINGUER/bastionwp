...
final class BastionWP_Activator
{
    public static function activate(): void
    {
        ...
        add_option('bastionwp_update_settings', ['owner' => 'BUSSINGUER', 'repo' => 'bastionwp', 'channel' => 'stable'], '', false);

        add_option(
            'bastionwp_wizard_state',
            [
                'first_run'    => true,
                'started'      => false,
                'current_step' => 0,
    ...
    private static function assert_environment(): void
    {
        ...
        if (is_multisite()) {
            ...
            wp_die(
                esc_html__('BastionWP 0.9.9.3 ainda é homologado somente para instalações WordPress single-site.', 'bastionwp'),
